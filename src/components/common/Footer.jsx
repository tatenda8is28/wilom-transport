      ...
      <div className="max-w-7xl mx-auto px-4 text-left">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          ...
          <div>
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="font-black text-2xl tracking-tighter italic uppercase">WILOM</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-6 font-bold text-slate-300 text-[13px]">
              <li className="flex items-start gap-4 text-left"><MapPin size={20} className="text-[#dc2626] shrink-0 mt-1"/><span>5790 Granary Phase 3, <br/>Harare, Zimbabwe</span></li>
              <li className="flex items-center gap-4 text-left"><Phone size={20} className="text-[#dc2626] shrink-0"/><span>UK: +44 7480 855 994</span></li>
              <li className="flex items-center gap-4 text-left"><Phone size={20} className="text-[#dc2626] shrink-0"/><span>ZIM: +263 710 500 296</span></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-10 text-slate-500 font-bold text-[10px] uppercase tracking-widest">
            {/* THESE ARE THE LINKS TO YOUR NEW PAGES */}
